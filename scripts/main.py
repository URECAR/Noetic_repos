...
isTest = True                      # Gripper가 장착되지 않은 Simulator를 위한 변수. True이면 그리퍼를 인식하지 않는다.
...
posj_Detect_pose = [-11.6, -86.25, 72.96, -78.2, -90.02, -9.08]               # 물체 인식 자세. 최적의 인식 장소를 가져야 함. 수정 시 ROI 영역도 수정해야 함.
...
class RealSense:            # 로봇팔 말단(eef)에 부착된 Realsense D435i 제어 클래스
    def __init__(self, duration=2):
        ...
        self.ROI_POINTS = np.array([(47,180), (56,432), (543, 438), (538, 172)], np.int32)    # 인식 범위를 픽셀 꼭짓점으로 지정
